...
var UnrealBloomPass = function(resolution, strength, radius, threshold) {
  ...
  for (var k = 0; k < this.nMips; k++) {
    this.separableBlurMaterials.push(
      this.getSeperableBlurMaterial(kernelSizeArray[k])
    );

    this.separableBlurMaterials[k].uniforms["texSize"].value = new Vector2(
      resx,
      resy
    );
...
UnrealBloomPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  dispose: function() {
    ...
    for (var k = 0; k < this.renderTargetsVertical.length; k++) {
      this.renderTargetsVertical[k].dispose();
    }
