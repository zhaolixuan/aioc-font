...
var WaterMaterial = function(renderer, camera, scene, options) {
  ...
  var mirrorShader = THREE.ShaderLib['WaterMaterial']
...
WaterMaterial.prototype = Object.create(THREE.Object3D.prototype)

WaterMaterial.prototype.renderWithMirror = function(otherMirror) {
...
WaterMaterial.prototype.render = function(isTempTexture) {
